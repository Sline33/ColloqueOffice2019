...
// Returns the public 'AppBundle\Controller\RecapController' shared autowired service.
...
include_once $this->targetDirs[3].'/src/AppBundle/Controller/RecapController.php';

return $this->services['AppBundle\Controller\RecapController'] = new \AppBundle\Controller\RecapController();
