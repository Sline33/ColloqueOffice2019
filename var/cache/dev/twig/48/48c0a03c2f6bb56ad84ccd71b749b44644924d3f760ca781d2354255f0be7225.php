...
";
    ...
    public function block_modal($context, array $blocks = array())
    {
        ...
        // line 29
        echo "        ";
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "session", array()), "flashBag", array()), "has", array(0 => "erreur"), "method")) {
            // line 30
            echo "          <div class=\"d-flex justify-content-center\" style =\"margin-top:20px;\">
              ";
            // line 31
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["msg"]) {
                // line 32
                echo "                  <p class=\"alert alert-danger\"><strong>";
                echo twig_escape_filter($this->env, $context["msg"], "html", null, true);
                echo "</strong> de vous <strong><a href=\"";
                echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("fos_user_registration_register");
                echo "\">inscrire</a></strong> ou de vous <a href=\"";
                echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("fos_user_security_login");
                echo "\"><strong>connecter</strong></a> pour acceder au formulaire.</p>
              ";
            }
    ...
    {
        return array (  228 => 36,  224 => 34,  211 => 32,  207 => 31,  204 => 30,  201 => 29,  192 => 28,  170 => 82,  157 => 72,  145 => 63,  132 => 53,  124 => 48,  116 => 43,  109 => 38,  106 => 37,  104 => 28,  99 => 26,  96 => 25,  90 => 22,  87 => 21,  85 => 20,  69 => 6,  60 => 5,  42 => 3,  11 => 1,);
    }
...
{% block body %}
    ...
    <section class=\"d-flex flex-column align-items-center\">
        ...
        <div style=\"margin-top:25px;\">
          <a class=\"btn btn-secondary\" role=\"button\" href=\"{{ path('fos_user_security_reservation') }}\" style=\"font-size:27px;\">RESERVEZ</a>
        </div>
        {% else %}
        <div style=\"margin-top:25px;\">
          <a class=\"btn btn-secondary\" role=\"button\" href=\"{{ path('fos_user_security_popup') }}\" style=\"font-size:27px;\">RESERVEZ</a>
        </div>
        {% block modal %}
        {% if app.session.flashBag.has('erreur') %}
          <div class=\"d-flex justify-content-center\" style =\"margin-top:20px;\">
              {% for msg in app.session.flashBag.get('erreur') %}
                  <p class=\"alert alert-danger\"><strong>{{msg}}</strong> de vous <strong><a href=\"{{ path('fos_user_registration_register') }}\">inscrire</a></strong> ou de vous <a href=\"{{ path('fos_user_security_login') }}\"><strong>connecter</strong></a> pour acceder au formulaire.</p>
              {% endfor %}
          </div>
          {% endif %}
        {% endblock %}
...
{% endblock %}
", "default/modal.html.twig", "/var/www/html/ColloqueOfficeWorking/app/Resources/views/default/modal.html.twig");
    }
}
